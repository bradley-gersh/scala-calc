...
object Parser {
   ...
   *                           3. parens:     a list of unclosed parentheses after parsing this expression
   */
  private def parseTermBranch(parseState: NestedParseState): Either[String, NestedParseState] = {
   ...
   *                           3. parens:     a list of unclosed parentheses after parsing this expression
   */
  private def parseFactorBranch(parseState: NestedParseState): Either[String, NestedParseState] = {
    val NestedParseState(tokensAfterLeft, leftRoot, newParensLeft) = parseState
